...
/*!***************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/postcss-loader/src??ref--5-2!./node_modules/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css ***!
  \***************************************************************************************************************************************************************************/
...
/*!*************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/postcss-loader/src??ref--5-2!./node_modules/filepond/dist/filepond.min.css ***!
  \*************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../css-loader??ref--5-1!../../postcss-loader/src??ref--5-2!./filepond-plugin-image-preview.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css");
...
var content = __webpack_require__(/*! !../../css-loader??ref--5-1!../../postcss-loader/src??ref--5-2!./filepond.min.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/filepond/dist/filepond.min.css");
...
/* harmony import */ var filepond_plugin_image_preview_dist_filepond_plugin_image_preview_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css */ "./node_modules/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css");
/* harmony import */ var filepond_plugin_image_preview_dist_filepond_plugin_image_preview_css__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(filepond_plugin_image_preview_dist_filepond_plugin_image_preview_css__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var filepond_plugin_file_validate_size__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! filepond-plugin-file-validate-size */ "./node_modules/filepond-plugin-file-validate-size/dist/filepond-plugin-file-validate-size.js");
/* harmony import */ var filepond_plugin_file_validate_size__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(filepond_plugin_file_validate_size__WEBPACK_IMPORTED_MODULE_6__);
...
filepond__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"](filepond_plugin_image_preview__WEBPACK_IMPORTED_MODULE_2___default.a);
filepond__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"](filepond_plugin_image_exif_orientation__WEBPACK_IMPORTED_MODULE_4___default.a);
filepond__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"](filepond_plugin_file_validate_type__WEBPACK_IMPORTED_MODULE_5___default.a);
filepond__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"](filepond_plugin_file_validate_size__WEBPACK_IMPORTED_MODULE_6___default.a);
var OFFLINE_CACHE = 'offline';
filepond__WEBPACK_IMPORTED_MODULE_0__["setOptions"]({
  server: {
    process: function process(fieldName, file, metadata, load, error, _progress, abort, transfer, options) {
      Vapor.store(file, {
        progress: function progress(percent) {
          _progress(true, Math.round(percent * 100), 100);
        }
      }).then(function (response) {
        load(response.uuid + '.' + response.extension);
      });
    },
    fetch: function fetch(url, load, error, progress, abort, headers) {
      caches.open(OFFLINE_CACHE).then(function (cache) {
        cache.match(url).then(function (response) {
          if (response === undefined) {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", url + '?cache=' + Math.random());
...
var filePondInputs = [];
$('.filePondInput').each(function (index, element) {
  var config = {
      maxFileSize: '10MB',
      instantUpload: false
  };
  var pond = filepond__WEBPACK_IMPORTED_MODULE_0__["create"](this, {...config, ...window.FILE_POND_CONFIG});

  if (element.defaultValue) {
    var files;

    try {
      files = JSON.parse(element.defaultValue);
    } catch (e) {
      files = [element.defaultValue];
    }

    files.forEach(function (file) {
      pond.addFile(file.toString());
    });
  }

  filePondInputs.push(pond);
});
$('.filePondForm').on('submit', function (e) {
  e.preventDefault();
  var form = this;
  Promise.all(filePondInputs.map(function (file) {
    return file.processFiles();
  })).then(function () {
    setTimeout(function () {
      form.submit();
    }, 500);
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/filepond.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/niraj/code/mlm/mlm-base-template/resources/js/filepond.js */"./resources/js/filepond.js");
