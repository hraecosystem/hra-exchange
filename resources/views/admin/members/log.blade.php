        ...
        <div class="col-12">
            <div class="card mt-2">
                ...
                <div id="filters" class="collapse show">
                    <div class="card-body">
                        <form action="{{ route('admin.members.log',$member) }}" id="filterForm">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{ route('admin.members.log',$member) }}"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-striped text-nowrap" id="membersTable">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>Date</th>
...
@push('page-javascript')
    <script>
        var dataTable = $('#membersTable').DataTable({
            ajax: {
                url: '{{ route('admin.members.log',$member) }}',
            },
            "columns": [
