        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p><strong>Equivalent Fiat:</strong> {{ number_format($bankTransferRequest->amount_fiat, 2) }} EUR {{-- Adjust currency --}}</p>
                ...
                <div class="col-md-6">
                    <p><strong>Status:</strong>
                        <span class="badge badge-{{ $bankTransferRequest->status == 'pending' ? 'warning' : ($bankTransferRequest->status == 'approved' ? 'success' : 'danger') }}">
                    ...
                    @if ($bankTransferRequest->status !== 'pending')
                        <p><strong>Processed At:</strong> {{ $bankTransferRequest->updated_at->format('Y-m-d H:i') }}</p>
                        ...
                        @if ($bankTransferRequest->payment_proof)
                            <p><strong>Payment Proof:</strong>
                                ...
                                @if (Storage::exists($bankTransferRequest->payment_proof))
                                    <a href="{{ Storage::url($bankTransferRequest->payment_proof) }}" target="_blank">View Proof</a>
                                @else
        ...
        <div class="card-body">
            @if ($bankTransferRequest->user)
                ...
                @if ($bankTransferRequest->user->member)
                    ...
                    <p><strong>Current HRA Balance:</strong> {{ number_format($bankTransferRequest->user->member->coin_wallet_balance ?? 0, 8) }}</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.bank-transfer-requests.approve', $bankTransferRequest) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                @error('payment_proof') {{-- Or transaction_id --}}
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.bank-transfer-requests.reject', $bankTransferRequest) }}" method="POST">
                            @csrf
