<nav class="layout-navbar container-fluid navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        <div id="google_translate_element" class="me-3 d-none d-sm-block"></div>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ settings()->getFileUrl('favicon', asset(env('FAVICON'))) }}" alt class="w-px-40 h-auto rounded-circle">
                    </div>
                </a>
                        ...
                        <a class="dropdown-item" href="javascript:void(0)">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar avatar-online">
                                        <img src="{{ settings()->getFileUrl('favicon', asset(env('FAVICON'))) }}" alt
