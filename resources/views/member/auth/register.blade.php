        ...
        <div class="auth-card">
            <div class="auth-content">
                <div class="auth-form">
                    ...
                    <form action="{{ route('member.verification.register') }}" method="post" {{-- <form action="{{ route('api.register.create') }}" method="post" --}}>
                        @csrf
                        <div class="form-floating form-floating-outline">
                            ...
                            @endforeach
                            @isset($hra_errors['username'])
                                <div class="text-danger">{{ $hra_errors['username'] }}</div>
                            @endisset

                        </div>
                        <div class="form-floating form-floating-outline">
                            <input id="last_name" class="form-control" type="text" placeholder="Enter Laste Name"
                                name="last_name" value="{{ old('last_name') }}" autocomplete="off" required>
                            <label for="last_name" class="required">Laste Name</label>
                        ...
                        <div class="form-floating form-floating-outline">
                            <input id="phonenumber" class="form-control" type="number" placeholder="Enter Phone number"
                                onkeydown="return max_length(this,event,6)" name="phonenumber"
                                value="{{ old('phonenumber') }}" autocomplete="off" required>
