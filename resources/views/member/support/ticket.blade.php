                                                                ...
                                                                <a href="{{ $ticket->getFirstMediaUrl(\App\Models\SupportTicketMessage::MC_IMAGE) }}"
                                                                   class="image-popup">
                                                                    <img
                                                                        ...
                                                                        class="img-fluid" alt="" style="width: 2.5rem;height: 2.5rem;object-fit: contain">
                                                                </a>
                                                            </div>
                                                        @endif
                                                    @else
                        ...
                        <div class="chat-history-footer">
                            ...
                            @else
                                <form method="post" onsubmit="send.disabled = true; return true;"
                                      action="{{ route('member.support.ticketMessage',[$supportTickets]) }}"
                                    ...
                                    <div class="row d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="col-lg-2 message-actions d-flex align-items-center justify-content-center">
